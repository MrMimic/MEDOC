                ...
                for insert_table in article_INSERT_list:
                    ...
                    if insert_table['name'] == 'medline_article_language':
                        ...
                        if (len(values_tot_medline_article_language) == parameters['database'][
                            'insert_command_limit']) or (articles_count == len(articles) - 1):
                            send_medline_article_language(values_medline_article_language[1],
                    ...
                    if insert_table['name'] == 'medline_article_publication_type':
                        ...
                        if (len(values_tot_medline_article_publication_type) == parameters['database'][
                            'insert_command_limit']) or (articles_count == len(articles) - 1):
                            send_medline_article_publication_type(values_medline_article_publication_type[1],
                                                                  values_tot_medline_article_publication_type,
                                                                  parameters)
                            values_tot_medline_article_publication_type = []
                    ...
                    if insert_table['name'] == 'medline_chemical_list':
                        ...
                        if (len(values_tot_medline_chemical_list) == parameters['database'][
                            'insert_command_limit']) or (articles_count == len(articles) - 1):
                            send_medline_chemical_list(values_medline_chemical_list[1],
                    ...
                    if insert_table['name'] == 'medline_citation_other_id':
                        ...
                        if (len(values_tot_medline_citation_other_id) == parameters['database'][
                            'insert_command_limit']) or (articles_count == len(articles) - 1):
                            send_medline_citation_other_id(values_medline_citation_other_id[1],
                    ...
                    if insert_table['name'] == 'medline_citation_subsets':
                        ...
                        if (len(values_tot_medline_citation_subsets) == parameters['database'][
                            'insert_command_limit']) or (articles_count == len(articles) - 1):
                            send_medline_citation_subsets(values_medline_citation_subsets[1],
                    ...
                    if insert_table['name'] == 'medline_comments_corrections':
                        ...
                        if (len(values_tot_medline_comments_corrections) == parameters['database'][
                            'insert_command_limit']) or (articles_count == len(articles) - 1):
                            send_medline_comments_corrections(values_medline_comments_corrections[1],
                                                              values_tot_medline_comments_corrections, parameters)
                            values_tot_medline_comments_corrections = []
                    ...
                    if insert_table['name'] == 'medline_data_bank':
                        ...
                        if (len(values_tot_medline_data_bank) == parameters['database']['insert_command_limit']) or (
                            articles_count == len(articles) - 1):
                            send_medline_data_bank(values_medline_data_bank[1], values_tot_medline_data_bank,
                                                   parameters)
                            values_tot_medline_data_bank = []
                    ...
                    if insert_table['name'] == 'medline_investigator':
                        ...
                        if (len(values_tot_medline_investigator) == parameters['database']['insert_command_limit']) or (
                            articles_count == len(articles) - 1):
                            send_medline_investigator(values_medline_investigator[1], values_tot_medline_investigator,
                                                      parameters)
                            values_tot_medline_investigator = []
                    ...
                    if insert_table['name'] == 'medline_mesh_heading':
                        ...
                        if (len(values_tot_medline_mesh_heading) == parameters['database']['insert_command_limit']) or (
                            articles_count == len(articles) - 1):
                            send_medline_mesh_heading(values_medline_mesh_heading[1], values_tot_medline_mesh_heading,
                                                      parameters)
                            values_tot_medline_mesh_heading = []
                    ...
                    if insert_table['name'] == 'medline_personal_name_subject':
                        ...
                        if (len(values_tot_medline_personal_name_subject) == parameters['database'][
                            'insert_command_limit']) or (articles_count == len(articles) - 1):
                            send_medline_personal_name_subject(values_medline_personal_name_subject[1],
                                                               values_tot_medline_personal_name_subject, parameters)
                            values_tot_medline_personal_name_subject = []
